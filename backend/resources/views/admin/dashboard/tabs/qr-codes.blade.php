...
<script>
    // Initialize QR codes charts when tab is shown
    if (typeof window.initQrCharts === 'function') {
        window.initQrCharts();
    } else {
        // Fallback: initialize immediately if already loaded
